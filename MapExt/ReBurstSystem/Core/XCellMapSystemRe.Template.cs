// [AUTO-GENERATED TEMPLATE] 请勿直接编辑生成文件，修改此模板后运行 GenerateCellMapSystemRe.ps1
// 占位符: __NAMESPACE__ -> 目标命名空间, __KMAPSIZE__ -> kMapSize 值
...
namespace MapExtPDX.MapExt.__NAMESPACE__
{
    /// <summary>
    ...
    public static class XCellMapSystemRe
    {
        ...
        public const int kMapSize = __KMAPSIZE__; //MapSizeMultiplier * 14336;
            ...
            NativeArray<AvailabilityInfoCell> AvailabilityInfoMap)
        {
            ...
            float4 availabilityInfo = AvailabilityInfoMap[cell.x + AvailabilityInfoToGridSystemkTextureSize * cell.y]
                .m_AvailabilityInfo;
            float4 y = cell.x < AvailabilityInfoToGridSystemkTextureSize - 1
                ? AvailabilityInfoMap[cell.x + 1 + AvailabilityInfoToGridSystemkTextureSize * cell.y].m_AvailabilityInfo
                : (float4)0;
            ...
            CitizenHappinessParameterData citizenHappinessParameterData, GarbageParameterData garbageParameterData)
        {
            ...
            GenericApartmentQuality genericApartmentQuality = GetGenericApartmentQuality(
        ...
        {
            GenericApartmentQuality result = default;
            bool flag = true;
