...
namespace MapExtPDX.MapExt.ReBurstSystemModeD
{
    ...
    public static class CellMapSystemRe
    {
        ...
        public static readonly int kMapSize = 229376; // MapSizeMultiplier * 14336;

        // WaterSystem CellSize/WaveSpeed
        public static readonly float kCellSize = 112f; // MapSizeMultiplier * 7f;
        public static readonly float WaveSpeed = 112f / 30f; // kCellSize / 30f;
