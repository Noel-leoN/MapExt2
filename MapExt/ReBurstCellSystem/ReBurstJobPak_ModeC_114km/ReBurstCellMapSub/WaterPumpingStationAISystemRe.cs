        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            for (int i = 0; i < chunk.Count; i++)
            {
                ...
                if (data.m_Types != AllowedWaterTypes.None)
                {
                    ...
                    {
                        // mod 
                        GroundWater groundWater = CellMapSystemRe.GroundWaterSystemGetGroundWater(nativeArray3[i].m_Position, this.m_GroundWaterMap);
                        ...
                        // mod
                        CellMapSystemRe.GroundWaterSystemConsumeGroundWater(nativeArray3[i].m_Position, this.m_GroundWaterMap, num9);
