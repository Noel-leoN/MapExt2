...
namespace MapExtPDX.MapExt.ReBurstSystemModeC
{
    ...
    public partial class ZoneAmbienceSystemMod : BaseCellMapSystem, IJobSerializable
	{
        ...
        public static readonly int kTextureSize = CellMapSystemRe.ZoneAmbienceSystemkTextureSize; // mod尺寸
        ...
        /// <summary>
        /// 氛围更新 Job
        /// <para>并行处理每一个网格单元。将累积器(Accumulator)的值转移到当前值(Value)中，并重置累积器。</para>
        /// </summary>
        [BurstCompile]
