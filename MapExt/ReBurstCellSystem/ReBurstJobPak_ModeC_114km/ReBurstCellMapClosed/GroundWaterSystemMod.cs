...
namespace MapExtPDX.MapExt.ReBurstSystemModeC
{
    ...
    public partial class GroundWaterSystemMod : BaseCellMapSystem, IJobSerializable
    {
        ...
        public static readonly int kTextureSize = CellMapSystemRe.GroundWaterSystemkTextureSize; // mod尺寸
        ...
        protected override void OnUpdate()
        {
            ...
            // 增加临时缓冲区引用
            groundWaterTickJob.m_TempMap = scratchMap;  // 传入临时缓冲区
        ...
        private struct GroundWaterTickJob : IJob
        {
            ...
            public NativeArray<int2> m_TempMap;      // 临时图 (传入的 TempJob)
