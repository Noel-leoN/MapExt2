    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            var entries = new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(ModSettings.PatchModeChoice)), "Changes require clicking 'Apply Changes'."  + "\r\n" + "\r\n" + "Mode List:" + "\r\n" + "ModeA: 57km  (4x4)  DEM:14m" + "\r\n" + "ModeB: 28km  (2x2)  DEM:7m" + "\r\n" + "ModeC: 114km  (8x8)  DEM:28m" + "\r\n" + "\r\n" + "ModeNone: 14km  vanilla(1x1)  DEM:3.5m" + "\r\n" + "Notice:" + "\r\n" + "1. Bigger MapSizes have worse DEM resolution, resulting in rough graphics for mountains, ramps, and waterfronts. If you have high requirements for terrain smoothness, it is recommended to build a flatter map or use some masking methods.\r\n2. The bigger the MapSize, the greater the calculation deviation of the economic simulation data at the edges. And it usually creates some false visuals. When using the 114km mode, it is recommended to build the active buildings in the center of the map as much as possible.\r\n ！！！STRONGLY RECOMMENDED to RESTART the game after changing the mapsize mode!!!"},
