    ...
    public static class PatchManager
    {
        ...
        static PatchManager()
        {
            ...
            s_AllPatchSets = new Dictionary<string, Action<Harmony>>
            {
                ...
                { "WaterSystemInitFix", (h) => WaterSystemReinitializer.Execute() },
                ...
                // 集中调用方式
                {
                    ...
                    (h) => ReBurstSystem.Core.JobPatchHelper.Apply(h, ReBurstSystem.Core.JobPatchDefinitions.GetCellSystemTargets(CurrentMode))
                },
            };
