...
- **New Systems**: Added ResourceBuyer & ServiceCoverage, plus ResidentAI pathfinding optimization.
...
- **新增系统**：加入了消费采购与服务覆盖寻路优化（ResourceBuyer & ServiceCoverage），以及居民AI寻路优化（ResidentAI）。
- **本地化**：完整的中英文设置面板本地化。
