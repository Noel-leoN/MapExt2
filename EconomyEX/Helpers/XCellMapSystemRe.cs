...
namespace EconomyEX.Helpers
{
    ...
    public static class XCellMapSystemRe
    {
        ...
        public const int kMapSize = 14336; // 原版标准地图大小

        // WaterSystem CellSize/WaveSpeed
        public const float kCellSize = 7f; // kMapSize / 14336 * 7f
        public const float WaveSpeed = 7f / 30f; // kCellSize / 30f
        ...
        public const int CellMapTextureSizeMultiplier = 1; // 原版地图倍率固定为1
