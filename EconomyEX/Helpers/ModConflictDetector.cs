...
namespace EconomyEX.Helpers
{
    ...
    public static class ModConflictDetector
    {
        ...
        /// <summary>
        /// 返回与 EconomyEX 当前启用的系统组存在直接冲突的 Mod 列表。
        /// </summary>
        public static string GetConflictReport(EconomyEX.Settings.ModSettings settings)
        {
            ...
            else if (HasUrbanInequality && settings.EnableEconomyFix)
            {
