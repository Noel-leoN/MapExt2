...
* From v2.0 All-in-one version, now you can switch to the vanilla mapsize(14km)/28km/57km/114km/229km in the MainMenu's Option UI without having to uninstall the mod. Also, the loadgame verification function has been added to avoid loading the gamesave with wrong mapsize, which can corrupt gamesave. However, it cannot to validate maps loaded in the map editor, you have to choose the right settings in Option UI.
