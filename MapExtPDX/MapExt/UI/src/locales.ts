...
export const locales = {
    en: {
        ...
        findJobMax: "Max pathfind cost multiplier for citizens seeking employment.\nHigher values allow longer commutes. Default: 14.3 (approx. 20.0 km)",
    ...
    zh: {
        ...
        findJobMax: "市民找工作的最大寻路成本乘数（基于出行优先级基准）。值越高允许更远的通勤距离。\n默认值：14.3（约 20.0 km）",
    ...
    zhHant: {
        ...
        findJobMax: "市民找工作的最大尋路成本乘數（基於出行優先級基準）。值越高允許更遠的通勤距離。\n預設值：14.3（約 20.0 km）",
