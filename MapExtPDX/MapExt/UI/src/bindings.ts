...
export const findJobMultiplier$     = bindValue<number>(G, "FindJobCostMultiplier", 14.3);
...
export const setFindJobMultiplier     = (v: number) => trigger(G, "SetFindJobCostMultiplier", v);
