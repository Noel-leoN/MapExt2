            ...
            for (int i = 0; i < m_AmbienceEntities.Length; i++)
            {
                ...
                switch (audioGroupingSettingsData.m_Type)
                {
                    case GroupAmbienceType.Traffic:
                        num2 = XCellMapSystemRe.TrafficAmbienceSystemGetTrafficAmbience2(m_CameraPosition, m_TrafficAmbienceMap, 1f / audioGroupingSettingsData.m_Scale).m_Traffic;
                        break;
                    ...
                    case GroupAmbienceType.NightForest:
                        {
                            ...
                            {
                                num2 = XCellMapSystemRe.ZoneAmbienceSystemGetZoneAmbience(GroupAmbienceType.Forest, m_CameraPosition, m_AmbienceMap, 1f / m_Settings[i].m_Scale);
                                if (entity2 != Entity.Null)
                                {
                                    num3 = XCellMapSystemRe.ZoneAmbienceSystemGetZoneAmbienceNear(GroupAmbienceType.Forest, m_CameraPosition, m_AmbienceMap, m_Settings[i].m_NearWeight, 1f / m_Settings[i].m_Scale);
                                }
                            }
                            break;
                        }
                    case GroupAmbienceType.Rain:
                        ...
                        break;
                    default:
                        num2 = XCellMapSystemRe.ZoneAmbienceSystemGetZoneAmbience(audioGroupingSettingsData.m_Type, m_CameraPosition, m_AmbienceMap, 1f / audioGroupingSettingsData.m_Scale);
                        if (entity2 != Entity.Null)
                        {
                            num3 = XCellMapSystemRe.ZoneAmbienceSystemGetZoneAmbienceNear(audioGroupingSettingsData.m_Type, m_CameraPosition, m_AmbienceMap, m_Settings[i].m_NearWeight, 1f / audioGroupingSettingsData.m_Scale);
                        }
                        break;
                }
