    ...
    public struct ObjectPolluteJob : IJobChunk
    {
        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            for (int i = 0; i < nativeArray.Length; i++)
            {
                ...
                GroundPollution pollution = XCellMapSystemRe.GroundPollutionSystemGetPollution(position, m_GroundPollutionMap);
                AirPollution pollution2 = XCellMapSystemRe.AirPollutionSystemGetPollution(position, m_AirPollutionMap);
