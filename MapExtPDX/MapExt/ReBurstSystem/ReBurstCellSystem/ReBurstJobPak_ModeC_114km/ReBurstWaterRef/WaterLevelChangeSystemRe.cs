...
using UnityEngine;
using static MapExtPDX.MapExt.ReBurstSystemModeC.XCellMapSystemRe;
    ...
    public struct WaterLevelChangeJob : IJobChunk
    {
        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            for (int i = 0; i < nativeArray3.Length; i++)
            {
                ...
                float num = (m_SimulationFrame - duration.m_StartFrame) / 60f - waterLevelChangeData.m_EscalationDelay;
                if (num < 0f)
                {
                    continue;
                }
