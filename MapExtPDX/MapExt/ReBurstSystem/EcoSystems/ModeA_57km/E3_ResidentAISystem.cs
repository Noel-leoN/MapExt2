...
namespace MapExt.ReBurstSystem.EcoSystems.ModeA_57km
{
	public partial class E3_ResidentAISystem : GameSystemBase
	{
		#region Constants
		...
		private struct ResidentTickJob : IJobChunk
		{
				...
				ref Divert divert, ref PathOwner pathOwner)
			{
				if (m_PedestrianLaneData.HasComponent(currentLane.m_Lane))
				{
					...
					DynamicBuffer<PathElement> dynamicBuffer = m_PathElements[entity];
					dynamicBuffer.Clear();
					NativeParallelHashSet<Entity> ignoreLanes = new NativeParallelHashSet<Entity>(16, Allocator.Temp)
						{ currentLane.m_Lane };
			...
			private bool TryFindNextLane(NativeParallelHashSet<Entity> ignoreLanes, ref Entity lane,
			...
			private bool TryFindNextLane(NativeParallelHashSet<Entity> ignoreLanes, Entity owner, ref Entity lane,
				ref float curveDelta)
			{
