...
namespace MapExt.ReBurstSystem.EcoSystems.ModeA_57km
{
	public partial class E3_ResidentAISystem : GameSystemBase
	{
		...
		protected override void OnUpdate()
				{
					...
					ResidentTickJob jobData = new ResidentTickJob
					{
						...
						m_EntityLookup = InternalCompilerInterface.GetEntityStorageInfoLookup(ref SystemAPI.GetEntityStorageInfoLookup, ref base.CheckedStateRef),
						...
						m_TaxiData = SystemAPI.GetComponentLookup<Game.Prefabs.TaxiData>(isReadOnly: true),
		...
		public NativeQueue<ResidentAction>.ParallelWriter m_ActionQueue;
					...
					private void FindNewPath(Entity entity, PrefabRef prefabRef, ref Unity.Mathematics.Random random, ref Game.Creatures.Resident resident, ref Human human, ref HumanCurrentLane currentLane, ref PathOwner pathOwner, ref Target target, ref Divert divert)
					{
						CreatureData creatureData = m_PrefabCreatureData[prefabRef.m_Prefab];
						...
						{
							if (!m_PrefabRefData.TryGetComponent(component2.m_Bicycle, out var componentData6) && m_CurrentBuildingData.TryGetComponent(resident.m_Citizen, out var componentData7) && componentData7.m_CurrentBuilding == entity2 && flag)
							{
								Unity.Mathematics.Random random2 = componentData3.GetPseudoRandom(CitizenPseudoRandom.BicycleModel);
								componentData6.m_Prefab = m_PersonalCarSelectData.SelectVehiclePrefab(ref random2, 1, 0, avoidTrailers: true, noSlowVehicles: false, bicycle: true, out var _);
							}
						...
						if (m_TravelPurposeData.TryGetComponent(resident.m_Citizen, out var componentData12))
						{
							...
							{
								flag2 = m_HealthProblemData.TryGetComponent(resident.m_Citizen, out var componentData13) && (componentData13.m_Flags & HealthProblemFlags.RequireTransport) != 0;
								break;
							}
		...
		public NativeQueue<ResidentAction> m_ActionQueue;
					...
					protected override void OnUpdate()
					{
						...
						BoardingJob jobData = new BoardingJob
						{
							...
							m_PublicTransportVehicleData = SystemAPI.GetComponentLookup<PublicTransportVehicleData>(isReadOnly: true),
							...
							m_OutsideConnections = SystemAPI.GetComponentLookup<Game.Objects.OutsideConnection>(isReadOnly: true),
