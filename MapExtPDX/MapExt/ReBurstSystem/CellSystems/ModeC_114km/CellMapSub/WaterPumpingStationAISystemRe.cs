    ...
    public struct PumpTickJob : IJobChunk
    {
        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            for (int i = 0; i < chunk.Count; i++)
            {
                ...
                {
                    Debug.LogError("WaterPumpingStation is missing producer edge!");
                    continue;
                }
                ...
                if (data.m_Types != AllowedWaterTypes.None)
                {
                    ...
                    {
                        // mod 
                        GroundWater groundWater = XCellMapSystemRe.GroundWaterSystemGetGroundWater(nativeArray3[i].m_Position, this.m_GroundWaterMap);
                        ...
                        // mod
                        XCellMapSystemRe.GroundWaterSystemConsumeGroundWater(nativeArray3[i].m_Position, this.m_GroundWaterMap, num9);
