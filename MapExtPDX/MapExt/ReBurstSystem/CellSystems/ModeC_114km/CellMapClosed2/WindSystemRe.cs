...
namespace MapExtPDX.ModeC
{
    ...
    public struct WindCopyJob : IJobFor
    {
        ...
        public void Execute(int index)
        {
            ...
            float2 xy = XCellMapSystemRe.WindSimulationSystemGetCenterVelocity(cell, m_Source).xy;
            float2 xy2 = XCellMapSystemRe.WindSimulationSystemGetCenterVelocity(cell2, m_Source).xy;
