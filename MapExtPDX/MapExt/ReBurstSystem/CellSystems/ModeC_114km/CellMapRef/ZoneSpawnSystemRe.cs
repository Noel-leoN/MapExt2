...
namespace MapExtPDX.ModeC
{
    ...
    public struct EvaluateSpawnAreas : IJobChunk
    {
        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            ZoneSpawnSystem.SpawnLocation bestLocation = default(ZoneSpawnSystem.SpawnLocation);
            ZoneSpawnSystem.SpawnLocation bestLocation2 = default(ZoneSpawnSystem.SpawnLocation);
            ZoneSpawnSystem.SpawnLocation bestLocation3 = default(ZoneSpawnSystem.SpawnLocation);
        ...
        private void TryAddLot(ref ZoneSpawnSystem.SpawnLocation bestLocation, ref Random random, Entity road, float curvePos, Entity entity, int4 area, LotFlags flags, int height, ZoneData zoneData, ZonePropertiesData zonePropertiesData, DynamicBuffer<ProcessEstimate> estimates, NativeList<IndustrialProcessData> processes, bool normal = true, bool storage = false)
        {
            ...
            if (this.m_BlockData.HasComponent(location.m_Entity))
            {
                ...
                NoisePollution pollution2 = XCellMapSystemRe.NoisePollutionSystemGetPollution(position, this.m_NoisePollutionMap);//
                AirPollution pollution3 = XCellMapSystemRe.AirPollutionSystemGetPollution(position, this.m_AirPollutionMap);//
