...
namespace MapExtPDX.ModeB
{
    ...
    public struct CalculateAverageAirPollutionJob : IJobChunk
    {
        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            {
                int2 airPollutionBonuses = XCellMapSystemRe.GetAirPollutionBonuses(nativeArray[i].m_Property, ref this.m_Transforms, this.m_AirPollutionMap, cityModifiers, in this.m_HappinessParameters);
